 ...
 public:
  ...
  iterator operator()(T value) {
    ...
    if (std::is_same<T, bool>::value) {
      ...
      if (fmt_specs.align == align::none || fmt_specs.align == align::numeric) fmt_specs.align = align::right;
...
OutputIt basic_printf_context<OutputIt, Char>::format() {
  ...
  return detail::write(out, basic_string_view<Char>(start, detail::to_unsigned(it - start)));
}
